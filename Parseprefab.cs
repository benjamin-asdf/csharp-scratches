...
namespace PrefabParsing {
    ...
    public static class Program {
        ...
        public static void Main(stirng[] args) {
            ...
            if (TrySuggestPrefabFix(string path, string content, out string suggestedContent)) {
                Console.WriteLine("=================== new prefab: ===========================");
                Console.WriteLine(suggestedContent);
            }
        ...
        public static bool TrySuggestPrefabFix(string path, string content, out string suggestedContent) {
            ...
            if (legacyCompRefRegex.IsMatch(content)) {
                Debug.LogWarning($"{path} - Encountered legacy prefab syntax. Skipping. You can enable and disable a game object + save to force it up to date.");
                return false;
            }
